...
class DataValidation:
    ...
    @staticmethod # static method belongs to the classs not object , local variable no need to use self , 
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if not status:
                error_message = f"train dataframe does on contains all columns. \n"
